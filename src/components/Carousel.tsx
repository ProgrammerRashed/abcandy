  ...
  return (
    <div className="font-dm carousel relative w-full flex justify-center items-center">
      <div className="relative w-full flex justify-center items-center overflow-hidden">
        <div
          className="flex justify-center  gap-[30px] translate-x-[345px] md:translate-x-[530px] lg:translate-x-[830px] lg:h-[650px] select-none"
              ...
              >
                ...
                <div>
                  {adjustedIdx === slide && (
                    <div
                      draggable={true}
                      className="card-body bg-white px-5  py-4  text-text-primary"
                    >
